...
**Date:** 2025-11-28
**Status:** Draft
**Source:** Two Claude instances using harness in real development scenarios
...
1. Read testing-anti-patterns skill:
   Use Skill tool: harness:testing-anti-patterns
...
1. **Configuration verification:**
   ...
   - Steven doesn't say "that's not actually testing what you think"
...
**Test Phase 2 with Steven before finalizing:**
