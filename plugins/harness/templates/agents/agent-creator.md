...
6. **Craft Triggering Description**: Write a description that:
   - Starts with "Use this agent when..."
   - Includes specific trigger phrases users would say
   - Covers different phrasings for the same intent
   - Is concise but comprehensive (under 500 characters)
