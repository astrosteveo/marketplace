...
description: Use when executing implementation plans with mostly independent tasks in the current session rather than separate parallel session. Applies when tasks can be worked on without tight coupling or shared state dependencies.
---
...
[Read plan file once: .artifacts/feature-name/YYYY-MM-DD-implementation-plan.md]
