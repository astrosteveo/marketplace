...
mkdir -p src test .artifacts/plans

# Create a simple implementation plan
cat > .artifacts/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .artifacts/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at .artifacts/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"harness:subagent-driven-development"' "$SESSION_FILE"; then
