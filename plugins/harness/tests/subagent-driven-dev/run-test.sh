...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/harness
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/harness-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using harness:subagent-driven-development. The plan is at: $PLAN_PATH"
