...
claude -p "I have a plan at docs/plans/auth-system/plan.md. Tell me about my options for executing it, including what subagent-driven-development means and how it works." \
    --model haiku \
